...
export function CinematicHero({ 
  ...
  return (
    ...
    >
      ...
      <img
        src="/zen_garden.png"
        alt="Zen Garden Mosaic"
        className="w-full h-full object-cover absolute inset-0 opacity-40 mix-blend-luminosity z-0"
      />
      <div className="bg-grid-theme absolute inset-0 z-0 pointer-events-none opacity-30" aria-hidden="true" />

      {/* Gooey Filter & Pixel Trail Mosaic Effect */}
      ...
      >
        <PixelTrail
          pixelSize={screenSize.lessThan(`md`) ? 24 : 48}
          fadeDuration={800}
          delay={0}
